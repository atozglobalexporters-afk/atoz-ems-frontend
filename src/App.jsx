      ...
      <Modal open={modal} onClose={() => setModal(false)} title="Add New Employee" width={560}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          ...
          <div style={{ gridColumn: "1/-1" }}>
            <FormField label="Basic Salary (₹)"><Inp value={form.basicSalary} onChange={e => setForm(p => ({ ...p, basicSalary: e.target.value }))} placeholder="e.g. 85000" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
          </div>
        </div>
    ...
    >
      ...
      <Modal open={modal} onClose={() => { setModal(false); setEditing(null); }} title={editing ? "Edit Work Log" : "Add Work Log"}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <FormField label="Hours Worked"><Inp value={form.hoursWorked} onChange={e => setForm(p => ({ ...p, hoursWorked: e.target.value }))} placeholder="e.g. 6" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
      ...
      <Modal open={createModal} onClose={() => setCreateModal(false)} title="Issue New Payslip" width={620}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
            ...
            <FormField label="Year"><Inp value={form.year} onChange={e => setForm(p => ({ ...p, year: Number(e.target.value) }))} type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
            <FormField label="Status">
          ...
          <div style={{ padding: 14, background: "rgba(34,197,94,0.05)", border: `1px solid ${C.green}22`, borderRadius: 10 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              {[["basic","Basic"],["hra","HRA"],["da","DA"],["specialAllowance","Special Allowance"],["bonus","Bonus"]].map(([k, l]) => (
                <FormField key={k} label={l}><Inp value={form[k]} onChange={e => setForm(p => ({ ...p, [k]: Number(e.target.value)||0 }))} type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
              ))}
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10 }}>
            <FormField label="Working Days"><Inp value={form.workingDays} onChange={e => setForm(p => ({ ...p, workingDays: Number(e.target.value)||0 }))} type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
            <FormField label="Leave Days"><Inp value={form.leaveDays} onChange={e => setForm(p => ({ ...p, leaveDays: Number(e.target.value)||0 }))} type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
            <FormField label="Overtime Hours"><Inp value={form.overtimeHours} onChange={e => setForm(p => ({ ...p, overtimeHours: Number(e.target.value)||0 }))} type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
          </div>
          ...
          return (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ padding: 14, background: "rgba(34,197,94,0.05)", border: `1px solid ${C.green}22`, borderRadius: 10 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  {[["basic","Basic"],["hra","HRA"],["da","DA"],["specialAllowance","Special Allowance"],["bonus","Bonus"]].map(([k, l]) => (
                    <FormField key={k} label={l}><Inp value={editModal[k]||0} onChange={e => setEditModal(p => ({ ...p, [k]: Number(e.target.value)||0 }))} type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
                  ))}
                </div>
              </div>
              <div style={{ padding: 14, background: "rgba(239,68,68,0.05)", border: `1px solid ${C.red}22`, borderRadius: 10 }}>
    ...
    >
      ...
      <Modal open={modal} onClose={() => setModal(false)} title={editTarget ? "Edit Order" : "New Order"} width={580}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
            <FormField label="Quantity"><Inp value={form.quantity} onChange={e => setForm(p => ({ ...p, quantity: e.target.value }))} placeholder="100" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
            ...
            <FormField label="Unit Price (₹)"><Inp value={form.price} onChange={e => setForm(p => ({ ...p, price: e.target.value }))} placeholder="500" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
          </div>
        ...
        <div className="card" style={{ padding: 24, marginBottom: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            ...
            <F label="Grace Period (minutes)">
              <Inp value={form.gracePeriodMinutes} onChange={e => setForm(p => ({ ...p, gracePeriodMinutes: e.target.value }))} placeholder="15" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
            <F label="Early Login Window (minutes before start)">
              <Inp value={form.earlyWindowMinutes} onChange={e => setForm(p => ({ ...p, earlyWindowMinutes: e.target.value }))} placeholder="30" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
            <F label="Half Day Cutoff After Grace (minutes)">
              <Inp value={form.halfDayCutoffMinutes} onChange={e => setForm(p => ({ ...p, halfDayCutoffMinutes: e.target.value }))} placeholder="105" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
            <F label="Hard Absent Cutoff After Grace (minutes)">
              <Inp value={form.absentCutoffMinutes} onChange={e => setForm(p => ({ ...p, absentCutoffMinutes: e.target.value }))} placeholder="165" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
            <F label="Minimum Work Hours (for Present)">
              <Inp value={form.minWorkingHours} onChange={e => setForm(p => ({ ...p, minWorkingHours: e.target.value }))} placeholder="7" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
            <F label="Half Day Threshold (hours)">
              <Inp value={form.halfDayHours} onChange={e => setForm(p => ({ ...p, halfDayHours: e.target.value }))} placeholder="4" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
            <F label="Session Timeout (hours)">
              <Inp value={form.sessionTimeoutHours} onChange={e => setForm(p => ({ ...p, sessionTimeoutHours: e.target.value }))} placeholder="8" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
            <F label="Auto End Buffer After Shift End (minutes)">
              <Inp value={form.autoEndBufferMinutes} onChange={e => setForm(p => ({ ...p, autoEndBufferMinutes: e.target.value }))} placeholder="0" type="text" inputMode="numeric" pattern="[0-9]*" />
            </F>
          </div>
            ...
            <div className="card" style={{ padding: 24 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  ...
                  <FormField label="Founded Year"><Inp value={form.foundedYear} onChange={e => setForm(p => ({ ...p, foundedYear: e.target.value }))} placeholder="2010" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
                </div>
    ...
    >
      ...
      <Modal open={modal} onClose={() => setModal(false)} title={editTarget ? "Edit Project" : "New Project"} width={560}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <FormField label="Budget (₹)"><Inp value={form.budget} onChange={e => setForm(p => ({ ...p, budget: e.target.value }))} placeholder="e.g. 500000" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 8 }}>
            {form.entries.map((entry, i) => (
              <div key={i} style={{ textAlign: "center" }}>
                ...
                <input className="inp" type="text" inputMode="numeric" pattern="[0-9]*" value={entry.hours} onChange={e => updateEntry(i, "hours", e.target.value)} placeholder="0" min="0" max="24" style={{ textAlign: "center", padding: "8px 4px" }} />
              </div>
            ))}
          </div>
    ...
    >
      ...
      <Modal open={acctModal} onClose={() => setAcctModal(false)} title="Add Bank Account" width={560}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <FormField label="Opening Balance (₹)"><Inp value={acctForm.openingBalance} onChange={e => setAcctForm(p => ({ ...p, openingBalance: e.target.value }))} placeholder="0" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
    ...
    >
      ...
      <Modal open={txnModal} onClose={() => setTxnModal(false)} title="Add Transaction" width={560}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <FormField label="Amount (₹) *"><Inp value={txnForm.amount} onChange={e => setTxnForm(p => ({ ...p, amount: e.target.value }))} placeholder="0.00" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
      ...
      <Modal open={genModal} onClose={() => setGenModal(false)} title="Generate Payroll">
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            ...
            <FormField label="Year"><Inp value={year} onChange={e => setYear(Number(e.target.value))} type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
          </div>
          <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
      ...
      <Modal open={modal} onClose={() => setModal(false)} title="Submit Expense">
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            ...
            <FormField label="Amount (₹)"><Inp value={form.amount} onChange={e => setForm(p => ({ ...p, amount: e.target.value }))} placeholder="e.g. 2500" type="text" inputMode="numeric" pattern="[0-9]*" /></FormField>
          </div>
          <FormField label="Date"><Inp value={form.date} onChange={e => setForm(p => ({ ...p, date: e.target.value }))} type="date" /></FormField>
        ...
        <div className="card" style={{ padding: 20 }}>
          ...
          <ResponsiveContainer width="100%" height={160}>
            <BarChart data={expenseCatData} barSize={24} layout="vertical">
              ...
              <XAxis type="text" inputMode="numeric" pattern="[0-9]*" tick={{ fill: C.t3, fontSize: 10 }} axisLine={false} tickLine={false} tickFormatter={v => `₹${(v/1000).toFixed(0)}k`} />
